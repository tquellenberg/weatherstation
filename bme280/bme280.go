...
func compensation(cv CompensationValues, rawTemp int32, rawPressure int32, rawHumidity int32) Result {
    ...
    if v_x1_u32r < 0 {
        fmt.Printf("Humidity value too small: %i\n", v_x1_u32r)
        v_x1_u32r = 0
    }
    if v_x1_u32r > 419430400 {
        fmt.Printf("Humidity value too big: %i\n", v_x1_u32r)
        v_x1_u32r = 419430400
    }
...
func InitBme280(address int) *BME280 {
    ...
    return &BME280{d, compensationValues}
}
